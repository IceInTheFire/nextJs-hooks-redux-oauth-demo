...
module.exports = __webpack_require__("Cf1b");
...
const Fetch = props => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_layout_homeLayout__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, props.poetrys.map((poetry, index) => {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
    key: index
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(next_link__WEBPACK_IMPORTED_MODULE_2___default.a, {
    as: `/normal/p/${poetry}`,
    href: `/normal/post?title=${poetry}`
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", null, poetry)));
})));

Fetch.getInitialProps = async function () {
  // const res = await fetch('http://www.yueqingfang.cn/api/poetry.js');
  const res = await isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_1___default()('http://localhost:3001/api/poetry');
